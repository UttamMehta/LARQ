...
document
  .getElementById("np_top")
  .append(bottles, Pitcher, GiftSets, Filters, Accessories);
...
data.map(function (el) {
  ...
  img.onclick = function () {
    ...
    window.location.href = "../../cart/pages/detailPage.html";
  };
...
button.onclick = function () {
  document.getElementById("img1").src =
    "https://res.cloudinary.com/larq/images/f_auto,q_auto/v1619383113/LARQ_Pitcher_MB_1/LARQ_Pitcher_MB_1.jpg";
};
let button2 = document.getElementById("n_button2");
button2.onclick = function () {
  document.getElementById("img1").src =
    "https://res.cloudinary.com/larq/images/f_auto,q_auto/v1619383123/LARQ_Pitcher_PW_1/LARQ_Pitcher_PW_1.jpg";
};
function fun1() {
